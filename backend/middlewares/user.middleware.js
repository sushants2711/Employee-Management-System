...
export const updateUserRoleMiddleware = async (req, res, next) => {
    try {
        ...
        if (error) {
            return validationErrorResponse(res, "Error Occured at Update User Role Validation", error.message);
        };
...
export const updateUserStatusMiddleware = async (req, res, next) => {
    try {
        ...
        if (error) {
            return validationErrorResponse(res, "Error Occured at Update User Status Validation", error.message);
        };
...
export const updateUserIsAvailableMiddleware = async (req, res, next) => {
    try {
        const schema = joi.object({
            isAvailable: joi.string().valid("Available", "Busy", "Do not distrub", "Appear offline", "Break Taken", "Meeting").required(),
        });

        const { error } = schema.validate(req.body);

        if (error) {
            return validationErrorResponse(res, "Error Occured at Update User IsAvailable Validation", error.message);
        };
...
export const updateUserDesignationMiddleware = async (req, res, next) => {
    try {
        ...
        if (error) {
            return validationErrorResponse(res, "Error Occured at Update User Designation Validation", error.message);
        };
...
export const updateUserDepartmentMiddleware = async (req, res, next) => {
    try {
        ...
        if (error) {
            return validationErrorResponse(res, "Error Occured at Update User Department Validation", error.message);
        };
...
export const updateUserTeamNameMiddleware = async (req, res, next) => {
    try {
        ...
        if (error) {
            return validationErrorResponse(res, "Error Occured at Update User TeamName Validation", error.message);
        };
...
export const updateUserPhoneNumberMiddleware = async (req, res, next) => {
    try {
        ...
        if (error) {
            return validationErrorResponse(res, "Error Occured at Update User PhoneNumber Validation", error.message);
        };
...
export const updateUserTypeMiddleware = async (req, res, next) => {
    try {
        ...
        if (error) {
            return validationErrorResponse(res, "Error Occured at Update User Type Validation", error.message);
        };
