...
import { Building2, Plus, X, Edit2, Trash2 } from "lucide-react";
import {
  createDepartment,
  getAllDepartments,
  updateDepartment,
...
function Departments() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showError(`Failed to ${modalConfig.mode.toLowerCase()} department`);
    } finally {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
            <Building2 className="w-7 h-7 text-ems-primary dark:text-ems-primary-dark" />
            Departments
          </h1>
