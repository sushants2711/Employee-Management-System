      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl p-8 border border-slate-100 dark:border-slate-700/50 relative overflow-hidden">
          ...
          <div className="mb-8 text-center mt-2">
            ...
            <h1 className="text-2xl font-bold text-ems-text-light dark:text-ems-text-dark mb-2">Management Sign In</h1>
            <p className="text-slate-500 dark:text-slate-400 text-sm">Restricted access: Only for company management team.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="flex items-center justify-between pt-2">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="remember-me-admin" className="ml-2 block text-sm text-slate-600 dark:text-slate-400 cursor-pointer">
                    Remember me
                  </label>
                </div>
